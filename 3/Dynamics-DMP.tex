...
Describe the model here. Start with the conceptual description, then move on to more rigorous, mathematical description. Link to paper by Figliozzi on Transportation Marketplaces.
