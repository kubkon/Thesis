...
\section{Mathematical Analysis} % (fold)
\label{sec:mathematical_analysis_notation}

\subsection{Invertibility of a Function} % (fold)
...
\end{proof}
% subsection invertibility_of_a_function (end)

\subsection{Lipschitz Condition} % (fold)
...
% subsection lipschitz_condition (end)
% subsection mathematical_analysis_notation (end)
...
\subsection{Order Statistics} % (fold)
...
\end{equation}
% subsection order_statistics (end)

\subsection{Strong Law of Large Numbers} % (fold)
...
\end{proof}
% subsection strong_law_of_large_numbers (end)
