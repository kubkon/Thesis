...
\subsection{Nonlinear Constrained Optimisation} % (fold)
\label{sub:nonlinear_constrained_optimisation_notation}
The following theorem on nonlinear constrained optimisation is also used in this thesis.
...
\end{proof}
% subsection nonlinear_constrained_optimisation_notation (end)
