...
\subsection{Theory of Games} % (fold)
\label{sub:theory_of_games_notation}

\subsubsection{Static Games with Incomplete Information} % (fold)
...
\subsubsection{Auction Theory} % (fold)
...
\subsubsection{Mechanism Design Theory} % (fold)
...
\subsection{Optimisation Theory} % (fold)
