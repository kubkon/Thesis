...
\begin{lstlisting}[caption=\lstinline{_handle_start()} member method of the \lstinline{EventHandler} class, label=listing:handle_start_method_eventhandler_simappendix]
@abstractmethod
