...
\chapter{Notation and Preliminaries} % (fold)
\label{cha:notation}

\minitoc
\vspace{10mm}

The following notation and concepts are assumed throughout the rest of this thesis.
...
\section{Optimization Theory} % (fold)
\label{sec:optimization_theory_notation}
...
\section{Theory of Games with Incomplete Information} % (fold)
\label{sec:theory_of_games_with_incomplete_information_notation}
...
% section game_theory_notation (end)

\section{Auction Theory} % (fold)
\label{sec:auction_theory_notation}
...
% section auction_theory_notation (end)

\section{Mechanism Design Theory} % (fold)
\label{sec:mechanism_design_theory_notation}
...
% section mechanism_design_theory_notation (end)
