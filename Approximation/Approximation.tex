...
Furthermore, it is worth noting that the mean relative errors in price and ex-ante expected utilities for all bidders is noisier from point to point than in 2 bidders' case. It is not immediately obvious why such a difference; however, there are two possible explanations that are incidentally closely related. Firstly,
