...
Secondly, the distribution specific parameters (mean and standard deviation) need to be specified for each bidder. Since the aim is to approximate the original distributions of both bidders, the midpoints of the original supports are picked as means for both bidders, that is,
\begin{equation}
