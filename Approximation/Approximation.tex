...
Similarly to the implementation of the FSM algorithm for the DMP auction, the approximation results presented in this chapter have been derived using the GSL implementation of the Embedded Runge-Kutta-Fehlberg (4,5) method.
...
\begin{figure}[p!]
  ...
  \caption{Expected utility functions for bidder 1 for CP and DMP auctions, and the estimated K-S statistic}
  \label{fig:test_compare_bidder_1_approximation}
  \vspace{10mm}
  \includegraphics[width=\figsize]{Approximation/Figures/test_compare_bidder_2}
  \caption{Expected utility functions for bidder 2 for CP and DMP auctions, and the estimated K-S statistic}
