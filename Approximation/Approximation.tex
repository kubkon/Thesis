...
In order to define the bidder's ex-ante expected utility, we first define the bidder's expected utility as
\begin{equation}
...
\begin{equation}
  ...
  \Pi_i \equiv E[\Pi_i(c_i)] = \int_{-\infty}^\infty \Pi_i(t)dF_i(t)
\end{equation}
