...
\begin{algorithmic}
  ...
  \Function{forwardShooting}{$low, high$}
    ...
    \EndIf
  \EndFunction
  \State{$\underline{\hat{b}}'\gets$ \Call{forwardShooting}{$\underline{\hat{c}}_2, \bar{\hat{b}}$}}
\end{algorithmic}
\end{algorithm}
...
\begin{algorithmic}
  \Function{polyProjection}{$k, totalK, params$}
    \State{$s$}
    \If{$k == totalK$}
      \State\Return{$s$}
    \Else
      \State\Return{\Call{polyProjection}{$k', totalK, params'$}}
    \EndIf
  \EndFunction
  \State{$s\gets$ \Call{polyProjection}{$3, 10, params$}}
\end{algorithmic}
\end{algorithm}
