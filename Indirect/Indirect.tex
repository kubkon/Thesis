...
In this subsection, we present the approximation results for two bidding scenarios using both algorithms: the forward shooting method and the polynomial projection method. The implementation details of the algorithms together with the instructions on how to us the Python scripts developed during this research work can be found in Appendix~\ref{cha:numerical_software}.
...
\begin{algorithmic}[1]
\Require{$\epsilon\in (0, \bar{\hat{b}} - \underline{\hat{c}}_2)$; $low, high\in [\underline{\hat{c}}_2, \bar{\hat{b}}]$ such that $low\leq high$; $p\in (0, 0.1)$}
\Ensure{Approximation to $\underline{\hat{b}}$}
  \Statex
  \Let{$low$}{$\underline{\hat{c}}_2$}
  \Let{$high$}{$\bar{\hat{b}}$}
...
\subsection{Approximation Results} % (fold)
\label{sub:approximation_results_indirect}
In this subsection, we present the approximation results for two bidding scenarios using both algorithms: the extended forward shooting method and the combined methods approach. The implementation details of the algorithms together with the instructions on how to us the Python scripts developed during this research work can be found in Appendix~\ref{cha:numerical_software}.
