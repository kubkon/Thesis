...
\subsection{Approximation Results} % (fold)
\label{sub:approximation_results_indirect}
In this subsection, we present the approximation results for two bidding scenarios using both algorithms: the extended forward shooting method and the combined methods approach. The implementation details of the algorithms together with the instructions on how to us the Haskell scripts developed during this research work can be found in Appendix~\ref{cha:haskell_numerical_tools}.
