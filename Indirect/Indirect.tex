...
To prove uniqueness, we note that since Assumptions~\ref{ass:assumptions_generic_indirect} are satisfied, then the additional condition (ii) in Theorem~1 in Lebrun~\cite{Lebrun2006} holds, and hence, the considered first-price auction has one and only one pure-strategy Bayesian Nash equilibrium where network operators bid at least their costs-hat.
\end{proof}
