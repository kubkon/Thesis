...
\subsection{Convergence of Numerical Algorithms} % (fold)
\label{sub:convergence_of_numerical_algorithms}
The quality of numerical solutions generated by both methods is very similar and of very high quality (at least as far as the sufficiency condition is concerned). However, it is crucial to appreciate the fact that due to the complex nature of the (extended) problem, the numerical solutions generated by both methods may not always yield satisfactory solutions. This is a direct consequence of the fact that the system of ODEs does not satisfy the Lipschitz condition of continuity. FIX:ME
% subsection convergence_of_numerical_algorithms (end)
