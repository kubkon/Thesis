...
\Ensure{Approximate $\underline{\hat{b}}$; $\alpha_i\in\mathbb{R}^K$ for all $i\in N$}
  ...
  \Function{polyProjection}{$k, K, \underline{b}, \alpha_1, \dotsc, \alpha_n$}
    ...
    \Let{$(\underline{b}', \alpha'_1, \dotsc, \alpha'_n)$}{minimize (??) with initial values $(\underline{b}, \alpha_1, \dotsc, \alpha_n)$}
    ...
    \Else
      \Let{$k'$}{$k + 1$}
      \For{$i\gets 1$ to $n$}
        \Let{$\alpha''_i$}{$(\alpha'^1_i, \dotsc, \alpha'^k_i, 10^{-6})$}
      \EndFor
