...
\textbf{Response:}
Section 7.2.1 discusses lack of temporal analysis of the network selection mechanism. One of the motivating factors for such an analysis is better understanding of supply and demand, and formation of the market equilibrium (regardless of whether it is actually achievable).
...
\textbf{Response:}
Further work section has been significantly expanded; see Section 7.2.
