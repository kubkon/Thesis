...
\begin{quote}
  A few researchers have considered the economic implications of intelligent network selection in their work; most notably Niyato and Hossain~[34], who explored the competitive pricing in a heterogeneous wireless access network, and Le Bodic \emph{et al.}~[8], who proposed a theoretical framework, Digital Marketplace, which strives to address ``tussle'' between different parties involved in the heterogeneous wireless access network. In the former case, the authors assume that the network operators have complete knowledge of the cost structure, etc., of their opponents; an unrealistic assumption as there is always some uncertainty present in a competitive environment. In the latter case, while the authors propose an auction-based scheme that addresses the uncertainty aspect of the market, they do not verify whether the proposed bidding strategies constitute an equilibrium of the proposed auction. In other words, their proposed mechanism lacks extensive economic analysis.
