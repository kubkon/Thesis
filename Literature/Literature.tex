...
\begin{figure}[ht]
    \centering
    \includegraphics[width=3.5in]{Literature/Figures/heterogeneous}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=4in]{Literature/Figures/wireless_city}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=4in]{Literature/Figures/abc}
