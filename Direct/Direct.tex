...
For the price weight of $w=0$, however, it was shown that the network operators will engage in abnormally high bidding (Proposition~\ref{prop:special_case_w_0_direct}). Hence, charging the buyer the maximum they are prepared to pay for the service.
