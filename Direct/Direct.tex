...
This chapter formally defines the network selection mechanism in the Digital Marketplace (DMP), and casts it into the framework of game theory. The mechanism is then direcly analysed for certain special cases.
...
Finally, a constraint optimisation problem is proposed that addresses negative bidding of the bidders. However, due to technical difficulties, an analytical solution is not formally derived; but, its form is conjectured (Conjecture~\ref{conj:pcomp_max_equi_bidding_str_direct}).
