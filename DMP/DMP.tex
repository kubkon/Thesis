...
There are many different auction formats reported in the auction theory literature; however, four are particularly popular, and are explored in this section. Those are English (also known as open ascending-price), Dutch (also known as open descending-price), first-price sealed-bid, and second-price sealed-bid auctions.
