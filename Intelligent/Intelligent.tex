...
The next section summarises the research efforts of the communications and economic community on the problem of intelligent network selection. The summary is divided into two sections: in the first section, a summary of research work covering mainly technological aspects of intelligent network selection is given, while in the second section, approaches considering economic aspects are outlined.
...
\label{sec:contributions_of_this_research_to_intelligent_network_selection}
