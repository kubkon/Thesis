...
\begin{figure}[htp]
	...
	\end{subfigure}
	\begin{subfigure}[b]{0.5\textwidth}
	  \includegraphics[width=3in]{2/Figures/expected_prices_small}
	  \caption{Small difference}
	  \label{fig:expected_prices_small}
	\end{subfigure}
	\vspace{0.5cm}\\
	\begin{subfigure}[b]{0.5\textwidth}
	  \includegraphics[width=3in]{2/Figures/expected_prices_medium}
	  \caption{Medium difference}
	  \label{fig:expected_prices_medium}
	\end{subfigure}
	\begin{subfigure}[b]{0.5\textwidth}
	  \includegraphics[width=3in]{2/Figures/expected_prices_large}
	  \caption{Large difference}
	  \label{fig:expected_prices_large}
	\end{subfigure}
\end{figure}
\begin{figure}[t]
  \caption{Relation}
